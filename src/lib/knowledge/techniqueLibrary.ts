...
const TECHNIQUE_SEEDS: TechniqueSeed[] = [
  ...
  {
    id: "parcial-60-40",
    name: "Parcial estrutural 60/40",
    category: "gestao",
    origin:
      "Gestão conservadora consolidada no sistema (parcial na primeira liquidez, restante no alvo)",
    context: "Qualquer entrada confirmada com plano completo.",
    trigger: "60% na parcial (primeira liquidez), 40% no alvo final; stop estrutural sempre.",
    invalidation: "—",
