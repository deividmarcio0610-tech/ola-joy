    ...
    <Card>
      <CardContent className="space-y-3 p-4">
        <div className="grid gap-3 sm:grid-cols-2">
          <Field label="O que será feito">
            <Textarea
              rows={2}
              value={plan.o_que}
              onChange={(e) => upd("o_que", e.target.value)}
              disabled={disabled}
            />
          </Field>
          <Field label="Por que será feito">
            <Textarea
              rows={2}
              value={plan.por_que}
              onChange={(e) => upd("por_que", e.target.value)}
              disabled={disabled}
            />
          </Field>
          <Field label="Onde">
            <Input
              value={plan.onde}
              onChange={(e) => upd("onde", e.target.value)}
              disabled={disabled}
            />
          </Field>
          <Field label="Quando (prazo)">
            <Input
              value={plan.quando}
              onChange={(e) => upd("quando", e.target.value)}
              disabled={disabled}
            />
          </Field>
          <Field label="Quem (responsável)">
            <Input
              value={plan.quem}
              onChange={(e) => upd("quem", e.target.value)}
              disabled={disabled}
            />
          </Field>
          <Field label="Como será executado">
            <Textarea
              rows={2}
              value={plan.como}
              onChange={(e) => upd("como", e.target.value)}
              disabled={disabled}
            />
          </Field>
          <Field label="Quanto (custo estimado)">
            <Input
              value={plan.quanto}
              onChange={(e) => upd("quanto", e.target.value)}
              disabled={disabled}
            />
          </Field>
          <Field label="Equipe">
            <Input
              value={plan.equipe}
              onChange={(e) => upd("equipe", e.target.value)}
              disabled={disabled}
            />
          </Field>
          ...
          <Field label="Data limite">
            <Input
              type="date"
              value={plan.data_limite ?? ""}
              onChange={(e) => upd("data_limite", e.target.value || null)}
              disabled={disabled}
            />
          </Field>
          <Field label="Prioridade">
            <Select
              ...
              onValueChange={(v) => upd("prioridade", v as Priority)}
              disabled={disabled}
            >
              <SelectTrigger>
                <SelectValue />
          ...
          <Field label="Situação">
            <Select
              value={plan.situacao}
              onValueChange={(v) => upd("situacao", v as RecordStatusV2)}
              disabled={disabled}
            >
              <SelectTrigger>
                <SelectValue />
        ...
        <Field label="Evidência necessária para encerramento">
          <Textarea
            rows={2}
            value={plan.evidencia_necessaria}
            onChange={(e) => upd("evidencia_necessaria", e.target.value)}
            disabled={disabled}
          />
        </Field>
